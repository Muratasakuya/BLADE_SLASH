...
#include <Game/Gameplay/Actors/Player/StateMachine/States/PlayerSkillAttackState.h>
...
void PlayerStateController::Init(Player* owner) {
	...
	machine.Add<PlayerSkillAttackState>(PlayerState::SkilAttack);
