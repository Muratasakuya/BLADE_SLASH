...
#include <Engine/Editor/Effect/User/Methods/EffectNode.h>
...
namespace SakuEngine {
	...
	public:
		...
		void Emit(const SakuEngine::Vector3& worldPos);
		...
		// ワールド座標を設定
		void SetWorldPos(const SakuEngine::Vector3& worldPos) { effectWorldPos_ = worldPos; }
