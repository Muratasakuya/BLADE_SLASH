...
#include <Engine/Editor/Effect/Particle/Core/GPUParticleUpdater.h>
#include <Engine/Editor/Effect/Particle/Core/ParticleRenderer.h>
...
namespace SakuEngine {
	...
	private:
		...
		ParticleManager() : IGameEditor("ParticleManager", "Tools") {}
