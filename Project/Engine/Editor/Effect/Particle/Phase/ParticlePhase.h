...
//	include
//============================================================================
#include <Engine/Editor/Effect/Particle/Module/Base/ICPUParticleSpawnModule.h>
...
namespace SakuEngine {
	...
	private:
		...
		// 各モジュールごとの登録されているクラスを管理するレジストリ
		using SpawnRegistry = EditorModuleRegistry<ICPUParticleSpawnModule, ParticleSpawnModuleID>;
		using UpdateRegistry = EditorModuleRegistry<ICPUParticleUpdateModule, ParticleUpdateModuleID>;
